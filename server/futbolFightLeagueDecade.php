...
if (isset($_GET['param1']) && isset($_GET['param2'])) {
   ...
   $prompt = "We are talking about football - as in soccer. The subject is $param1 in the $param3. Give me an argument-worthy topic about about the $param1 league in this time period that would get football fans debating passionately. Keep it concise, provocative, and in the form of a question that would spark a proper pub argument. It can include any knowledge you have about the teams, players, and games in that era to make it more interesting, including any controversial plays, moments, or events, or questions about which player was better than another player, or which game was the best game, or who was the most important player that seasion. Keep it concise, provocative, and in the form of a question that would spark a proper pub argument. Return just the question, no other text.";    // Initialize a cURL session
