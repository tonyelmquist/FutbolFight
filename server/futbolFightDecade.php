...
if (isset($_GET['param1']) && isset($_GET['param2'])) {
    ...
    $prompt = "Give me an argument-worthy topic about the team $param2 in the $param3 that would get football (soccer) fans debating passionately. It can include any knowledge you have about the teams, players, and games in that era to make it more interesting, including any controversial plays, moments, or events, or questions about which player was better than another player, or which game was the best game, or who was the most important player that seasion. Keep it concise, provocative, and in the form of a question that would spark a proper pub argument. Return just the question, no other text.";    // Initialize a cURL session
